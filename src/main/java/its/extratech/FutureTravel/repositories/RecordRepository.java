...
public interface RecordRepository extends JpaRepository<Record, Long> {
    ...
    @Query(value = "SELECT * FROM STORICO s " +
            ...
            "ORDER BY s.TIME ASC ;", nativeQuery = true)
    List<Record> selByIdAlloggio(@Param("idAlloggio") String idAlloggio);
    ...
    @Query(value = "SELECT * FROM STORICO s " +
            ...
            "ORDER BY s.TIME ASC ;", nativeQuery = true)
    List<Record> selByIdAlloggioAndByIdProvincia(@Param("idAlloggio") String idAlloggio,
    ...
    @Query(value = "SELECT * FROM STORICO s " +
            ...
            "ORDER BY s.TIME ASC ;", nativeQuery = true)
    List<Record> selByIdResidenza(@Param("idResidenza") String idResidenzaClienti);
    ...
    @Query(value = "SELECT * FROM STORICO s " +
            ...
            "AND p.ID_PROVINCIA LIKE :idProvincia " +
            "ORDER BY s.TIME ASC ;", nativeQuery = true)
    List<Record> selByIdResidenzaAndByIdProvincia(@Param("idResidenza") String idResidenzaClienti,
                                                  @Param("idProvincia") String idProvincia);
